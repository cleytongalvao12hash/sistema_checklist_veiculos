...
def exportar_excel():
    ...
    for log in historico:
        ...
        comb_saida, obs_saida_limpa, _ = extrair_dados_obs(log.obs_saida)
        ...
        # Adiciona automaticamente TODAS as colunas do Checklist (Apenas para a Entrada)
        for item in LISTA_CHECKLIST:
            nome_coluna = f"[Entrada] {item}"
            linha_dados[nome_coluna] = chk_entrada.get(item, "")
